"""
Complete the implementation of the masked attention module (class MaskedAttention(nn.Module))
in gpt.py. You may use testimplementation.py to verify your implementation before proceeding with training
...
class MaskedAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Expand the mask to match attention_logits' shape: (batch_size * num_heads, seq_length, seq_length)
